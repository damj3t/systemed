...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tecnomed&view=recetas'); ?>" method="post" name="adminForm">
	...
	<thead>
		<tr>
			...
			<th width="10%">
                                <?php echo JText::_('JFIELD_MEDICAMENTO_LABEL');?>
			</th>
			<th width="20%">
                        	<?php echo JText::_('JFIELD_POSOLOGIA_LABEL'); ?>
            </th>
            <th width="20%">
	...
	foreach ($this->items as $i => $item) :	
		$canCreate      = $user->authorise('core.create','com_tecnomed.receta.'.$item->id);
        $link 		= JRoute::_( 'index.php?option=com_tecnomed&task=receta.edit&id='. $item->id );
		?>
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td>
                <?php echo $this->escape($item->farmaco); ?>
					
           </td>
			<td>
                <a href="<?php echo $link;?>">
                <?php echo $this->escape($item->posologia); ?></a>
            </td>
            <td>
                <?php //echo $this->escape($item->farmaco_id); ?>
