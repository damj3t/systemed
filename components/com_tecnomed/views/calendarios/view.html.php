...
class TecnomedViewCalendarios extends JView
{
	protected $items;
        ...
        public function display($tpl = null)
        {
				...
				$this->Profesionals		= $this->get('Profesionals');
                $this->Profesional		= $this->get('Profesional');
                $this->AgendaProf		= $this->get('AgendaProf');
                // Check for errors.
