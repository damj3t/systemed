...
<form action="<?php JRoute::_('index.php?option=com_tecnomed'); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'COM_TECNOMED_FICHA_MEDICA' ); ?></legend>
		...
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'COM_TECNOMED_ANEXO' ); ?></legend>
			<ul class="adminformlist">
			<?php foreach($this->form->getFieldset('otrainfo') as $field): ?>
							<li><?php echo $field->label;echo $field->input;?></li>
			<?php endforeach; ?>
			</ul> 
		 </fieldset>
		   <input type="hidden" name="option" value="com_tecnomed" />
	       <input type="hidden" name="task" value="paciente.save" />
	...
	<div class="width-40 fltrt">
		...
		<?php //echo JHtml::_('sliders.panel',JText::_('COM_TECNOMED_IMAGE_PACIENTE'), 'paciente-details'); ?>
            <fieldset class="adminform">
            <legend><?php echo JText::_( 'COM_TECNOMED_IMAGEN_PACIENTE' ); ?></legend>
			<ul class="adminformlist">
